...
public class SplashScreen extends SharedMediaActivity {
  ...
  public static final String ACTION_OPEN_ALBUM = "paneeer.OPEN_ALBUM";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    parentView = findViewById(R.id.splash_bg);
    logoView = findViewById(R.id.imgLogo);

    parentView.setBackgroundColor(ColorPalette.getObscuredColor(getBackgroundColor()));
    ...
    try {
      gifDrawable = new GifDrawable(getAssets(), "paneeer.gif");
    } catch (IOException e) {
      e.printStackTrace();
    }
    if (gifDrawable != null) {
  ...
  private class PrefetchAlbumsData extends AsyncTask<Boolean, Boolean, Boolean> {
    ...
    protected void onPostExecute(Boolean result) {
      ...
      nextIntent = new Intent(SplashScreen.this, GalleryMainActivity.class);
      Bundle b = new Bundle();
