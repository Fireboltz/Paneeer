...
import org.amfoss.paneeer.gallery.activities.SingleMediaActivity;
...
import org.amfoss.paneeer.opencamera.Preview.Preview;
import org.amfoss.paneeer.opencamera.UI.FolderChooserDialog;
import org.amfoss.paneeer.opencamera.UI.MainUI;
...
public class CameraActivity extends ThemedActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    increaseZoom = findViewById(R.id.increase_zoom);
    decreaseZoom = findViewById(R.id.decrease_zoom);
  ...
  public boolean usingKitKatImmersiveMode() {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
      ...
      String immersive_mode =
        ...
        return immersive_mode.equals("immersive_mode_gui")
  ...
  public boolean usingKitKatImmersiveModeEverything() {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
      ...
      String immersive_mode =
          sharedPreferences.getString(
              PreferenceKeys.getImmersiveModePreferenceKey(), "immersive_mode_low_profile");
        return immersive_mode.equals("immersive_mode_everything");
    }
    return false;
  }
  ...
  public boolean hasAudioControl() {
    ...
    } else return audio_control.equals("noise");
  }
