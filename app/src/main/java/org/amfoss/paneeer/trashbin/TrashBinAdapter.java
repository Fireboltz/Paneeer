...
public class TrashBinAdapter extends RecyclerView.Adapter<TrashBinAdapter.ViewHolder> {
  ...
  public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder(View itemView) {
      super(itemView);
      deleteTime = itemView.findViewById(R.id.delete_time);
      deleteDate = itemView.findViewById(R.id.delete_date);
      deletedImage = itemView.findViewById(R.id.trashbin_image);
      popupMenuButton = itemView.findViewById(R.id.textViewOptions);
      date = itemView.findViewById(R.id.date);
      time = itemView.findViewById(R.id.time);
      deleteDetails = itemView.findViewById(R.id.delete_details);
    }
  }
}
