package org.amfoss.paneeer.trashbin;
...
import org.amfoss.paneeer.gallery.activities.SettingsActivity;
...
public class TrashBinActivity extends ThemedActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    trashBinRecyclerView = findViewById(R.id.trashbin_recycler_view);
    toolbar = findViewById(R.id.toolbar);
    emptyView = findViewById(R.id.empty_trash);
    emptyIcon = findViewById(R.id.image_trash);
    trashText = findViewById(R.id.trash_text);
    swipeRefreshLayout = findViewById(R.id.swipeRefreshLayout_trashbin);
