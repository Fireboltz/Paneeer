...
import org.amfoss.paneeer.base.BaseActivity;
...
public class BackgroundRenderer {
   ...
   */
  public void draw(Frame frame, Activity activity) {
    try {
      if (frame == null) {
        return;
      }
      ...
      activity.runOnUiThread(new Runnable() {
        public void run() {
          Intent arCameraIntent = new Intent(activity, ARMainActivity.class);
          activity.startActivity(arCameraIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
          activity.finish();
        }
      });
    }
